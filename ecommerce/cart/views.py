...
def order_form(request):
    if(request.method=="POST"):
        ...
        client=razorpay.Client(auth=('rzp_test_6oIzk9jyTNaR5R','CSTenIxX6BfqHEaNHsSNFlSC'))
...
def payment_status(request,u):
  ...
  if(request.method=="POST"):
    ...
    client=razorpay.Client(auth=('rzp_test_6oIzk9jyTNaR5R','CSTenIxX6BfqHEaNHsSNFlSC'))#to check the authentication of rayzorpay signature
    print(client)
    try:
